...
# Loading mat file
data = loadmat('D:\Deep Learning\Experiment-2-Implement character and digit recognition using ANN\mnist-original.mat')
...
hidden_layer_size = 400  # Increased hidden layer size
...
# Experimenting with different lambda and iteration values
maxiter = 100
lambda_reg = 1  # Regularization to prevent overfitting
